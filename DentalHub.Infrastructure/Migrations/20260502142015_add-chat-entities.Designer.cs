...
namespace DentalHub.Infrastructure.Migrations
{
    ...
    [Migration("20260502142015_add-chat-entities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DentalHub.Domain.Entities.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("DentalHub.Domain.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("DentalHub.Domain.Entities.Media", b =>
                {
                    ...
                    b.HasOne("DentalHub.Domain.Entities.CaseType", null)
                        .WithMany("Medias")
                    ...
                    b.HasOne("DentalHub.Domain.Entities.Patient", null)
                        .WithMany("Medias")
                    ...
                    b.HasOne("DentalHub.Domain.Entities.SessionNote", "SessionNote")
                        .WithMany("Medias")
            ...
            modelBuilder.Entity("DentalHub.Domain.Entities.Message", b =>
                {
                    b.HasOne("DentalHub.Domain.Entities.Conversation", "Conversation")
                        .WithMany("Messages")
